...
figure_1_e <- read_excel("Source_Data_Figure_1.xlsx", sheet = 'Figure1e' )

x <- c(min(figure_1_e$first_peak_l2fc, na.rm = TRUE), max(figure_1_e$first_peak_l2fc, na.rm = TRUE))
	
y <- c(min(figure_1_e$second_peak_l2fc, na.rm = TRUE), max(figure_1_e$second_peak_l2fc, na.rm = TRUE)) 
...
figure_1_f <- read_excel("Source_Data_Figure_1.xlsx", sheet = 'Figure1f' )

x <- c(
    min(figure_1_f$second_peak_l2fc, na.rm = TRUE),
    max(figure_1_f$second_peak_l2fc, na.rm = TRUE)
)
y <- c(
    min(figure_1_f$third_peak_l2fc, na.rm = TRUE),
    max(figure_1_f$third_peak_l2fc, na.rm = TRUE)
)
...
figure_1_g <- read_excel("Source_Data_Figure_1.xlsx", sheet = 'Figure1g' )

x <- c(min(figure_1_g$third_peak_l2fc, na.rm = TRUE), max(figure_1_g$third_peak_l2fc, na.rm = TRUE))
y <- c(min(figure_1_g$fourth_peak_l2fc, na.rm = TRUE), max(figure_1_g$fourth_peak_l2fc, na.rm = TRUE)) 
...
figure_1_h <- read_excel("Source_Data_Figure_1.xlsx", sheet = 'Figure1h')
...
basemean_split_plot(figure_1_h, "MCF7")
...
figure_1_i <- read_excel("Source_Data_Figure_1.xlsx", sheet = 'Figure1i')
...
distance_split_plot(figure_1_i, "MCF7")
